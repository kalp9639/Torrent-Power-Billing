    ...
    def run(self):
        ...
        try:
            ...
            if billing_demand <= 50:
                ...
                fixed_charge = (50 * 175) + ((billing_demand - 50) * 230)  # ₹175 for first 50 kW, ₹230 for next 30 kW
            else:
                fixed_charge = (50 * 175) + (30 * 230) + ((billing_demand - 80) * 300)  # ₹300 for demand above 80 kW

            # Excess Demand Charge (if billing demand exceeds contract demand)
            excess_demand_charge = 0
            if billing_demand > contract_demand:
                excess_demand_charge = (billing_demand - contract_demand) * 425  # ₹425 per kW for excess demand
