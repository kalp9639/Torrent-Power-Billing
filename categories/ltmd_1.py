    ...
    def run(self):
        ...
        try:
            ...
            if billing_demand <= 50:
                ...
                fixed_charge = (50 * 150) + (
                    (billing_demand - 50) * 185
                )  # ₹150 for first 50 kW, ₹185 for next 30 kW
            else:
                fixed_charge = (
                    (50 * 150) + (30 * 185) + ((billing_demand - 80) * 245)
                )  # ₹245 for demand above 80 kW
            ...
            if billing_demand > contract_demand:
                ...
                ) * 350  # ₹350 per kW for excess demand
